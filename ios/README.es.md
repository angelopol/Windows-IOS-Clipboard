...
Tres atajos de la app **Atajos** conectan tu iPhone con el portapapeles
...
| Atajo | Qué hace | Guía |
|-------|----------|------|
| **Enviar Clipboard** | Sube al servidor la selección (menú de compartir) o el portapapeles | [enviar-clipboard.es.md](enviar-clipboard.es.md) |
| **Ver Personal** | Últimos 5 textos subidos **desde este iPhone** (`scope=personal`) | [ver-clipboard.es.md](ver-clipboard.es.md) |
| **Ver Compartido** | Últimos 5 de **todos los dispositivos** (`scope=shared`) | [ver-compartido.es.md](ver-compartido.es.md) |
...
Detalle completo en [`web/README.es.md`](../web/README.es.md).
